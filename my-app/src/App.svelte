...
<main class="max-w-md w-screen h-screen">
  ...
  >
    ...
    >
      ...
      {#if !opening_manu}
      <a href="https://www.louhau.edu.mo/" class="mb-2 mx-6 text-black">收件匣</a>
      {/if}
    </div>
    <div class="flex mt-2 p-4 hover:bg-green-100 rounded-lg"
    ...
    >
      ...
      {#if !opening_manu}
      <a href="https://www.louhau.edu.mo/" class="mb-2 mx-6 text-black">新信息</a>
      {/if}
    </div>
    <div class="flex mt-2 p-4 hover:bg-green-100 rounded-lg"
  ...
  <div class="md:translate-y-12 max-w-md w-screen max-h-[500px] h-full rounded-xl bg-white mb-2 pt-2">
  ...
  <!--writing mail-->
  {#if current_index === 0}
  <div class="relative max-w-md w-screen max-h-[500px] h-full rounded-xl space-y-2 bg-white mb-2 p-4">
    ...
    <div class="absolute bottom-2 flex space-x-2 items-center">
      <button type="submit" class="text-xs bg-green-100 active:text-yellow-300">傳送</button>
      <div class="hover:bg-gray-300 p-2 rounded-full">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
