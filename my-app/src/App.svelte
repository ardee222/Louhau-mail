...
<main class="max-w-md w-screen h-screen">
  ...
  <div class="md:visible invisible positive max-w-xs w-full max-h-screen h-screen bg-white absolute left-0 top-0 flex flex-col p-6">
    <div class="flex m-4">
      <div class="flex justify-center items-center text-bold text-xl bg-green-200 text-orange-300 w-10 h-10 rounded-lg">
        <div>LH</div>
      </div>
      <div class="my-2 mx-6 text-xl">Louhau mail</div>
    </div>
    <div class="flex my-4 p-4 bg-gray-400 hover:bg-gray-500 rounded-lg w-40 drop-shadow-lg"
  ...
  <div class="md:translate-y-12 max-w-md w-screen max-h-screen h-screen rounded-xl bg-white mx-auto mb-10 pt-2">
